...
<div class="col-lg-8">
    <form action="/transaksi/{{ $transaksi->id }}" method="POST">
        ...
        <div class="mb-3">
            ...
            aria-describedby="tanggal_transaksi" name="tanggal_transaksi" required value="{{ $transaksi->tanggal_transaksi }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="hidden" class="form-control" id="alamat" 
            aria-describedby="alamat" name="alamat" required  value="{{ $transaksi->alamat }}" > 
        </div>
        <div class="mb-3">
            {{-- <label for="outlet" class="form-label">Outlet</label> --}}
            <input type="hidden" class="form-control" id="outlet" 
        ...
        <div class="mb-3">
            ...
            <input type="hidden" class="form-control" id="tunai" 
        ...
        <div class="mb-3">
            ...
            <select class="form-select" style="font-size: 16px" aria-label="Default select example" name="status">
                ...
                <option value="Belum Terantar">Belum Terantar</option>
              </select>
        </div>
